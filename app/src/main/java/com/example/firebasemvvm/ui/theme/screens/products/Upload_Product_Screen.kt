package com.example.firebasemvvm.ui.theme.screens.products
...
import com.example.firebasemvvm.ui.theme.ForestGreen
import com.example.firebasemvvm.ui.theme.GoldenRod
import com.example.firebasemvvm.ui.theme.Jose
import com.example.firebasemvvm.ui.theme.Joseph
import com.example.firebasemvvm.ui.theme.Purple
...
fun ViewUploadsScreen(navController: NavHostController) {
    val gradientBackground = Brush.verticalGradient(
        colors = listOf(ForestGreen, GoldenRod)
    )
...
fun UploadItem(
    ...
    Card(
        ...
        Column(
            ...
            Text(text = "Price: $price", fontSize = 14.sp, color = Jose)
            ...
            Row(
                ...
                Button(
                    ...
                    colors = ButtonDefaults.buttonColors(containerColor = Joseph),
